...
const SidebarContent = props => {
  ...
  const activeMenu = useCallback(() => {
    ...
    if(fullPath == '/funds-transfer/registered-payee'){
      matchingMenuItem = items['2'];
    }else if(fullPath == '/register-payee'){
      matchingMenuItem = items['1'];
    }else if (fullPath == '/payee-transaction-history'){
      matchingMenuItem = items['1'];
    }else if (fullPath == '/funds-transfer/new-payee'){
      matchingMenuItem = items['2'];
    }else if (fullPath == '/global-accounts'){
      ...
      <SimpleBar style={{ maxHeight: "100%" }} ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            {/* <li>
              <Link to="/source-of-funds" className="waves-effect">
                <i className="ti-stats-up"></i>
                <span>{props.t("Source Of Funds")}</span>
              </Link>
            </li>

            <li>
              <Link to="/top-up" className="waves-effect">
                <i className="ti-hand-point-up"></i>
                <span>{props.t("Top Up")}</span>
              </Link>
            </li> */}

            <li>
              <Link to="/payee" className="waves-effect">
                <i className="ti-user"></i>
                <span>{props.t("PAYEE")}</span>
              </Link>
            </li>

            <li>
              <Link to="/funds-transfer" className="waves-effect">
                <i className="ti-share"></i>
                <span>{props.t("FUND_TRANSFER")}</span>
              </Link>
            </li>
            ...
            {/* <li>
              <Link to="/inquiry" className="waves-effect">
                ...
                <span>{props.t("INQUIRY")}</span>
              </Link>
            </li> */}

            {/* <li>
              <Link to="/pages-starter" className="waves-effect">
                <i className="ti-money"></i>
                <span>{props.t("Move Money")}</span>
              </Link>
            </li>
